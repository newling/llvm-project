...
// CHECK: [[IN1:%.+]] = vector.extract_strided_slice [[V]] {offsets = [0], sizes = [4]} : vector<9xf8E4M3FN> to vector<4xf8E4M3FN>
...
// CHECK: [[IN2:%.+]] = vector.extract_strided_slice [[V]] {offsets = [4], sizes = [4]} : vector<9xf8E4M3FN> to vector<4xf8E4M3FN>
...
// CHECK: [[IN3:%.+]] = vector.extract_strided_slice [[V]] {offsets = [8], sizes = [1]} : vector<9xf8E4M3FN> to vector<1xf8E4M3FN>
...
// CHECK: [[W:%.+]] = vector.extract_strided_slice [[W0]] {offsets = [0], sizes = [2]} : vector<4xf8E5M2> to vector<2xf8E5M2>
...
// CHECK: [[V1:%.+]] = vector.extract_strided_slice [[CAST]] {offsets = [4], sizes = [4]} : vector<11xf8E4M3FN> to vector<4xf8E4M3FN>
...
// CHECK: [[V2:%.+]] = vector.extract_strided_slice [[CAST]] {offsets = [8], sizes = [3]} : vector<11xf8E4M3FN> to vector<3xf8E4M3FN>
