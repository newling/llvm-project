...
func.func @entry() {
  ...
  %11 = vector.insert_strided_slice %A, %cst {offsets = [0, 0]} : vector<2x2xf32> into vector<2x4xf32>
  %D = vector.insert_strided_slice %B, %11 {offsets = [0, 2]} : vector<2x2xf32> into vector<2x4xf32>
