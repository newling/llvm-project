...
// CHECK:           %[[V_INPUT_0:.*]] = vector.extract_strided_slice %[[V_INPUT_R]]
// CHECK-SAME:        {offsets = [0, 0, 0], sizes = [3, 1, 4]} : vector<3x7x4xi8> to vector<3x1x4xi8>
// CHECK:           %[[V_INPUT_1:.*]] = vector.extract_strided_slice %[[V_INPUT_R]]
// CHECK-SAME:        {offsets = [0, 2, 0], sizes = [3, 1, 4]} : vector<3x7x4xi8> to vector<3x1x4xi8>
// CHECK:           %[[V_INPUT_2:.*]] = vector.extract_strided_slice %[[V_INPUT_R]] 
// CHECK-SAME:        {offsets = [0, 4, 0], sizes = [3, 1, 4]} : vector<3x7x4xi8> to vector<3x1x4xi8>
// CHECK:           %[[V_INPUT_3:.*]] = vector.extract_strided_slice %[[V_INPUT_R]]
// CHECK-SAME:        {offsets = [0, 1, 0], sizes = [3, 1, 4]} : vector<3x7x4xi8> to vector<3x1x4xi8>
// CHECK:           %[[V_INPUT_4:.*]] = vector.extract_strided_slice %[[V_INPUT_R]]
// CHECK-SAME:        {offsets = [0, 3, 0], sizes = [3, 1, 4]} : vector<3x7x4xi8> to vector<3x1x4xi8>
// CHECK:           %[[V_INPUT_5:.*]] = vector.extract_strided_slice %[[V_INPUT_R]]
// CHECK-SAME:        {offsets = [0, 5, 0], sizes = [3, 1, 4]} : vector<3x7x4xi8> to vector<3x1x4xi8>
...
// CHECK-SAME:        {offsets = [0, 6, 0], sizes = [3, 1, 4]} : vector<3x7x4xi8> to vector<3x1x4xi8>
...
// CHECK-SAME:        {offsets = [0, 0, 0], sizes = [3, 1, 4]} : vector<3x3x4xi8> to vector<3x1x4xi8>
// CHECK:           %[[V_OUTPUT_1:.*]] = vector.extract_strided_slice %[[V_OUTPUT_R]]
// CHECK-SAME:       {offsets = [0, 1, 0], sizes = [3, 1, 4]} : vector<3x3x4xi8> to vector<3x1x4xi8>
// CHECK:           %[[V_OUTPUT_2:.*]] = vector.extract_strided_slice %[[V_OUTPUT_R]]
// CHECK-SAME:        {offsets = [0, 2, 0], sizes = [3, 1, 4]} : vector<3x3x4xi8> to vector<3x1x4xi8>
...
// CHECK-SAME:        {offsets = [0, 0, 0]} : vector<3x1x4xi8> into vector<3x3x4xi8>
// CHECK:           %[[VAL_75:.*]] = vector.insert_strided_slice %[[VAL_67]], %[[VAL_74]]
// CHECK-SAME:        {offsets = [0, 1, 0]} : vector<3x1x4xi8> into vector<3x3x4xi8>
// CHECK:           %[[VAL_76:.*]] = vector.insert_strided_slice %[[VAL_73]], %[[VAL_75]]
// CHECK-SAME:        {offsets = [0, 2, 0]} : vector<3x1x4xi8> into vector<3x3x4xi8>
