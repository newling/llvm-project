...
func.func @insert_strided_slice(%a: vector<4x4xf32>, %b: vector<4x8x16xf32>) {
  ...
  %1 = vector.insert_strided_slice %a, %b {offsets = [100]} : vector<4x4xf32> into vector<4x8x16xf32>
}
...
func.func @insert_strided_slice(%a: vector<4x4xf32>, %b: vector<4x8x16xf32>) {
  ...
  %1 = vector.insert_strided_slice %b, %a {offsets = [2, 2]} : vector<4x8x16xf32> into vector<4x4xf32>
}
...
func.func @insert_strided_slice(%a: vector<4x4xf32>, %b: vector<4x8x16xf32>) {
  ...
  %1 = vector.insert_strided_slice %a, %b {offsets = [100,100,100]} : vector<4x4xf32> into vector<4x8x16xf32>
}
...
func.func @insert_strided_slice(%a: vector<4x4xf32>, %b: vector<4x8x16xf32>) {
  ...
  %1 = vector.insert_strided_slice %a, %b {offsets = [2, 7, 2]} : vector<4x4xf32> into vector<4x8x16xf32>
}
...
func.func @insert_strided_slice_scalable(%a : vector<1x1x[2]xi32>, %b: vector<1x4x[4]xi32>) -> vector<1x4x[4]xi32> {
  ...
  %0 = vector.insert_strided_slice %a, %b {offsets = [0, 3, 0]} : vector<1x1x[2]xi32> into vector<1x4x[4]xi32>
...
func.func @insert_strided_slice_scalable(%a : vector<1x1x4xi32>, %b: vector<1x4x[4]xi32>) -> vector<1x4x[4]xi32> {
  ...
  %0 = vector.insert_strided_slice %a, %b {offsets = [0, 3, 0]} : vector<1x1x4xi32> into vector<1x4x[4]xi32>
  return %0 : vector<1x4x[4]xi32>
}
...
func.func @extract_strided_slice(%arg0: vector<4x8x16xf32>) {
  ...
  %1 = vector.extract_strided_slice %arg0 {offsets = [2, 2, 2, 2], sizes = [2, 2, 2, 2]} : vector<4x8x16xf32> to vector<2x2x16xf32>
}
...
func.func @extract_strided_slice_scalable(%arg0 : vector<1x4x[4]xi32>) -> vector<1x1x[2]xi32> {
    // expected-error@+1 {{op expected size at idx=2 to match the corresponding base size from the input vector (2 vs 4)}}
    %1 = vector.extract_strided_slice %arg0 {offsets = [0, 3, 0], sizes = [1, 1, 2]} : vector<1x4x[4]xi32> to vector<1x1x[2]xi32>
...
func.func @extract_strided_slice(%arg0: vector<4x8x16xf32>) {
  ...
  %1 = vector.extract_strided_slice %arg0 {offsets = [2], sizes = [3]} : vector<4x8x16xf32> to vector<3x8x16xf32>
}
...
func.func @extract_strided_slice(%arg0: vector<4x8x16xf32>) {
  ...
  %1 = vector.extract_strided_slice %arg0 {offsets = [2], sizes = [2]} : vector<4x8x16xf32> to vector<3x1xf32>
}
