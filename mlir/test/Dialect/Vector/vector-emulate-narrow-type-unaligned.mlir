...
// CHECK: %[[EXCTRACT:.+]] = vector.extract_strided_slice %[[VEC_I2]] {offsets = [2], sizes = [3]} : vector<8xi2> to vector<3xi2>
...
// CHECK: vector.extract_strided_slice %[[BITCAST]] {offsets = [2], sizes = [3]} : vector<8xi2> to vector<3xi2>
...
// CHECK-SAME: {offsets = [2]} : vector<5xi2> into vector<8xi2>
...
// CHECK-SAME: {offsets = [2]} : vector<5xi1> into vector<8xi1>
// CHECK: %[[SELECT:.+]] = arith.select %[[INSERT2]], %[[BITCAST2]], %[[INSERT1]] : vector<8xi1>, vector<8xi2>
// CHECK: vector.extract_strided_slice %[[SELECT]] {offsets = [2], sizes = [5]} : vector<8xi2> to vector<5xi2>
...
// CHECK-SAME: {offsets = [1]} : vector<5xi2> into vector<8xi2>
...
// CHECK-SAME: {offsets = [1]} : vector<5xi1> into vector<8xi1>
...
// CHECK-SAME: {offsets = [1], sizes = [5]} : vector<8xi2> to vector<5xi2>
...
// CHECK:           %[[SLICE_1:.*]] = vector.extract_strided_slice %[[ARG_0]] {offsets = [0], sizes = [1]} : vector<4xi2> to vector<1xi2>
// CHECK:           %[[V1:.*]] = vector.insert_strided_slice %[[SLICE_1]], %[[INIT]] {offsets = [3]} : vector<1xi2> into vector<4xi2>
...
// CHECK:           %[[VAL_16:.*]] = vector.extract_strided_slice %[[ARG_0]] {offsets = [1], sizes = [3]} : vector<4xi2> to vector<3xi2>
// CHECK:           %[[V2:.*]] = vector.insert_strided_slice %[[VAL_16]], %[[INIT]] {offsets = [0]} : vector<3xi2> into vector<4xi2>
...
// CHECK-SAME: {offsets = [0], sizes = [2]} : vector<3xi2> to vector<2xi2>
// CHECK: %[[INSERT:.+]] = vector.insert_strided_slice %[[EXTRACT]], %[[CST_0]]
// CHECK-SAME: {offsets = [2]} : vector<2xi2> into vector<4xi2>
...
// CHECK-SAME: {offsets = [2], sizes = [1]} : vector<3xi2> to vector<1xi2>
// CHECK: %[[INSERT2:.+]] = vector.insert_strided_slice %[[EXTRACT3]], %[[CST_0]]
// CHECK-SAME: {offsets = [0]} : vector<1xi2> into vector<4xi2>
...
// First atomic RMW:
// CHECK: %[[EXTRACT:.+]] = vector.extract_strided_slice %[[ARG0]]
// CHECK-SAME: {offsets = [0], sizes = [1]} : vector<7xi2> to vector<1xi2>
// CHECK: %[[INSERT:.+]] = vector.insert_strided_slice %[[EXTRACT]], %[[CST0]]
// CHECK-SAME: {offsets = [3]} : vector<1xi2> into vector<4xi2>
...
// CHECK-SAME: {offsets = [1], sizes = [4]} : vector<7xi2> to vector<4xi2>
...
// CHECK: %[[EXTRACT3:.+]] = vector.extract_strided_slice %[[ARG0]]
// CHECK-SAME: {offsets = [5], sizes = [2]} : vector<7xi2> to vector<2xi2>
// CHECK: %[[INSERT2:.+]] = vector.insert_strided_slice %[[EXTRACT3]], %[[CST0]]
// CHECK-SAME: {offsets = [0]} : vector<2xi2> into vector<4xi2>
...
// CHECK-SAME: {offsets = [1]} : vector<1xi2> into vector<4xi2>
